  ...
  if (argv.includes('--help') || argv.includes('-h')) {
    console.log(
      [
        ...
        '  shop products by-handle --handle "my-product"',
        '',
        '  # Create a product',
        '  shop products create --set title="New Product" --set status=DRAFT',
        '  shop products create --input @product.json',
        '',
        '  # Update a product',
        '  shop products update --id 123 --set title="Updated Title"',
        '  shop products set-status --id 123 --status ACTIVE',
        '',
        '  # Duplicate a product',
        ...
        '',
        '  # Delete a product',
        '  shop products delete --id 123 --yes',
        '',
        '  # Manage tags',
        '  shop products add-tags --id 123 --tags "sale,featured"',
        '  shop products remove-tags --id 123 --tags "clearance"',
        '  shop products tags  # list all tags',
        '',
        '  # Variants',
        '  shop products variants list --id 123',
        ...
        '  shop products variants delete --id 123 --variant-id 456',
        '  shop products variants reorder --id 123 --variant-id 456 --position 1',
        '  shop products set-price --variant-id 456 --price 19.99',
        '',
        '  # Options',
        '  shop products options-create --product-id 123 --options \'[{"name":"Size","values":[{"name":"S"},{"name":"M"}]}]\'',
        '  shop products option-update --product-id 123 --option \'{"id":"gid://shopify/ProductOption/1"}\'',
        '  shop products options-reorder --product-id 123 --options \'[{"id":"gid://shopify/ProductOption/1","position":1}]\'',
        '',
        '  # Media',
        '  shop products media list --id 123',
        '  shop products media add --id 123 --url "https://example.com/image.jpg"',
        '  shop products media upload --id 123 --file ./photo.jpg',
        '  shop products media update --media-id gid://shopify/MediaImage/1 --alt "Product photo"',
        ...
        '',
        '  # Bundles',
        '  shop products bundle-create --input @bundle.json',
        '  shop products bundle-update --input @bundle.json',
        '',
        '  # Metafields',
        '  shop products metafields upsert --id 123 --set namespace=custom --set key=color --set value=red',
        '',
        '  # Selling plans',
        '  shop products join-selling-plan-groups --id 123 --group-ids 456',
        '  shop products leave-selling-plan-groups --id 123 --group-ids 456',
      ].join('\n'),
    )
    return
  }
